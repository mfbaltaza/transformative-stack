		...
		<section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-900">
			...
			<div className="relative z-10 container mx-auto px-6 text-center">
				<div className="animate-fade-in-up">
					...
					<h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-white via-gray-200 to-gray-300 bg-clip-text text-transparent leading-tight">
						Transformative
					</h1>

					<span className="block text-sm text-gray-400 mb-6">
						{mocks_enabled ? "MOCKS ENABLED" : "MOCKS DISABLED"}
					</span>

					<p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
						Build exceptional web applications with the power of React Router.
						Navigate seamlessly, load efficiently, and transform user
						experiences.
					</p>
					...
					<div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
						...
						<a
							href="https://github.com/mfbaltaza/transformative-stack/tree/main"
